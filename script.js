...
//defining variables and their initial value
let password = "";
...
function handleSlider() {
    ...
    lengthSlider.style.backgroundSize =
      ((passwordLength - min) * 100) / (max - min) + "% 100%"; //didn't understand
}
...
function generatePassword(){
    ...
    if (password.length) password = ""; //how this worked- didn't understand
